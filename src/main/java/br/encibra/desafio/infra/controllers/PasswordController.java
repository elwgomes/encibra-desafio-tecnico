...
public class PasswordController {
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Passwords retrieved successfully", content = @Content(schema = @Schema(implementation = PasswordHttpResponse.class))),
	...
	@Operation(summary = "Create a new password", description = "This endpoint creates a new password for the authenticated user.")
	@ApiResponses(value = {
			@ApiResponse(responseCode = "201", description = "Password created successfully", content = @Content(schema = @Schema(implementation = PasswordHttpResponse.class))),
	...
	@Operation(summary = "Update an existing password", description = "This endpoint updates an existing password for the authenticated user.")
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Password updated successfully", content = @Content(schema = @Schema(implementation = PasswordHttpResponse.class))),
	...
	@Operation(summary = "Delete a password", description = "This endpoint deletes an existing password for the authenticated user.")
	@ApiResponses(value = {
	...
	public ResponseEntity<Void> delete(
			@Parameter(description = "Bearer token for authentication", required = true) @RequestHeader("Authorization") String authorizationHeader,
			@Parameter(description = "ID of the password to delete", required = true) @PathVariable Long passwordId)
			throws Exception {
		String token = authorizationHeader.replace("Bearer ", "");
